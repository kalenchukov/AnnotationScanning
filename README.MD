...
dev.kalenchukov.test.packages.films.Film.class
dev.kalenchukov.test.packages.films.Video.class
dev.kalenchukov.test.packages.musics.rock.RockMusic.class
dev.kalenchukov.test.packages.musics.Music.class
*/
```